...
class OrderFilterPresentationController: UIPresentationController {
    ...
    @objc func chromeTapped(_ sender: UITapGestureRecognizer) {
        ...
        let notification = Notification(name: Notification.Name(rawValue: "orderFilterChromeTapped"))
    ...
    override var frameOfPresentedViewInContainerView: CGRect {
        ...
        let ordersViewController = containerViewController.embeddedNavigationController.topViewController as! OrdersViewController
        let filterButton = ordersViewController.filterButton!
        ...
        let presentedViewYOrigin = filterButtonConvertedFrame.origin.y + 8.0
